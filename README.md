...
🌐 **[View Live Portfolio →](https://yourusername.github.io/analytics-portfolio)**
...
| Metric | Result |
|---|---|
| Collections analytics | $50M incremental balances recovered |
| Reporting automation | 98% reduction in weekly prep time |
| ML workforce optimization | $1.4M annualized FTE savings |
| Dashboard adoption | 100+ users across executive & associate tiers |
...
|---|---|---|---|
| 01 | PTP Rate Decline — Decomposing 930 Basis Points | Collections · Root Cause Analysis | 930 bps decomposed |
| 02 | Concurrent Loan Analysis | Loan Portfolio · Segmentation | $46M incremental collections |
| 03 | Member Engagement Dashboard — 3-Tier Tableau System | Performance Management | 100+ active users |
...
**Visualization:** Tableau · Power BI · Google Looker Studio · DAX · Power Query

**Analytics & Engineering:** SQL · Python · R · ETL Pipelines · Data Modeling

**Methods:** Predictive Modeling · Cohort Analysis · Statistical Testing · Forecasting · Segmentation

**Domain:** FinTech · Lending · Collections · Workforce Planning · Compliance · CPG · Healthcare
...
*If the work is interesting and the analytics problem is real, I'm always open to a conversation.*
